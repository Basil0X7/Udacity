...
def calculates_results_stats(results_dic):
    ...
    # how many not dogs in images do you have
    ...
    #حساب النسبة المئوية للصور التي تم تصنيفها بشكل صحيح
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img']) * 100
    else:
        results_stats_dic['pct_correct_dogs'] = 0
    # حساب النسبة المئوية للكلاب التي تم تصنيف سلالاتها بشل صحيح
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img']) * 100
    else:
        results_stats_dic['pct_correct_breed'] = 0
    #حساب النسبة المئوية للصور التي ليست كلاباً
